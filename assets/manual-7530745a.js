import{S as Ce,i as Oe,s as Me,e as n,a as s,c as Se,g as o,m as Le,k as We,n as Ne,o as i,q as Pe,u as De,t as $e}from"./index-d1fc1cc6.js";import"./Modal.svelte_svelte_type_style_lang-14adb101.js";import{B as _e}from"./all.min-f5212bae.js";function He(d){let a;return{c(){a=$e("Back to NPW")},m(r,l){o(r,a,l)},d(r){r&&i(a)}}}function Ie(d){let a,r,l,E,u,G,p,R,h,U,c,J,f,K,m,Q,b,V,y,X,w,Z,g,ee,k,te,x,oe,v,ie,T,ne,C,se,O,ae,M,le,S,re,L,de,W,ue,N,pe,P,he,D,ce,$,fe,_,me,H,be,I,ye,A,we,q,ge,B,ke,Y,xe,j,ve,z,F;return l=new _e({props:{$$slots:{default:[He]},$$scope:{ctx:d}}}),l.$on("click",d[0]),{c(){a=n("h1"),a.textContent="Network Planning Workspace User Manual",r=s(),Se(l.$$.fragment),E=s(),u=n("p"),u.textContent="Not ready yet",G=s(),p=n("h2"),p.textContent="Technical details",R=s(),h=n("p"),h.textContent=`These are some notes about how NPW works (not how to use it). Maybe this will
  ...
  NPW.`,Q=s(),b=n("ul"),b.innerHTML=`<li>Motorways are excluded (
    ...
    need to support new off-road segments that could be parallel.)</li> <li>Most OSM highway types for roads are included</li> <li>Anything currently under construction is excluded</li> <li>Steps/stairs are excluded, because unless this becomes an appropriate ramp,
  ...
  road.`,Z=s(),g=n("h3"),g.textContent="Starting a network",ee=s(),k=n("p"),k.textContent=`You can start with a completely blank network, or you can initially seed your
  ...
  it.`,ie=s(),T=n("h3"),T.textContent="Drawing routes",ne=s(),C=n("p"),C.textContent=`To draw a route, you pick a sequence of two or more waypoints on the map. The
  ...
  How do we determine attractive streets?`,ye=s(),A=n("h3"),A.textContent="Reachability",we=s(),q=n("p"),q.innerHTML=`Some of the metrics determine if a population zone, town centre, or POI
