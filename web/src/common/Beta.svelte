...
<Modal bind:show>
  ...
  <p>
    The Network Planning Workspace (part of the <a
      href="https://npt.scot"
      target="_blank"
    >
      NPT
  ...
  <p>
    ...
    and other trip purpose results are based on pre-pandemic data. These
    model-based estimates may not reflect current patterns which have changed
    since the pandemic.
  </p>
  <p>
    Users are solely responsible for how they interpret and use the data. If you
    identify any errors or have concerns about the data or tool, please use the
    feedback form to report or provide feedback.
  </p>
  <p>
